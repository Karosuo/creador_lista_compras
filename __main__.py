...
# lista_articulos_completos = mezcla_listas(productos_base, suma_recetas)
...
#     print_lista_de_compras(mezcla_listas(resta=True, lista_articulos_completos, articulos_refri))
# ))

print("\nLista de recetas:\n{!s}".format(suma_recetas))